...
It will create an "html" directory in TOP_LEVEL/build/doc)
...
- [OBSOLETE] To build the MJ2 executables: '-DBUILD_MJ2:bool=on' (default: 'OFF')
- [OBSOLETE] To build the JPWL executables and JPWL library: '-DBUILD_JPWL:bool=on' (default: 'OFF')
- [OBSOLETE] To build the JPIP client (java compiler recommended) library and executables: '-DBUILD_JPIP:bool=on' (default: 'OFF')
- [OBSOLETE] To build the JPIP server (need fcgi) library and executables: '-DBUILD_JPIP_SERVER:bool=on' (default: 'OFF')
